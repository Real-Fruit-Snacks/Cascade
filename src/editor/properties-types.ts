...
export const PROP_TYPES: { type: PropType; label: string; icon: string }[] = [
...
export const TYPE_ICONS: Record<PropType, string> = {
...
export const TAG_COLORS = ['mauve', 'blue', 'teal', 'green', 'peach', 'pink'];
