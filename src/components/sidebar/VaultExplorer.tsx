...
import type { TreeSettings } from './file-tree-types';
import { loadExpandedPaths, saveExpandedPaths, getFolderColorsMap, flattenVisibleEntries, collectFolderPaths, sortTree, filterTree } from './tree-utils';
